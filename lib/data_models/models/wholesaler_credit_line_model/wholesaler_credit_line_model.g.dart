...
WholesalerCreditLineData _$WholesalerCreditLineDataFromJson(
    ...
    WholesalerCreditLineData(
      ...
      associationId: json['association_id'] as int? ?? 0,
      fieId: json['fie_id'] as String? ?? '',
      bpIdF: json['bp_id_f'] as int? ?? 0,
      bpIdR: json['bp_id_r'] as int? ?? 0,
      ...
      statusFie: json['status_fie'] as int? ?? 0,
      approvedCreditLineAmount:
          json['approved_credit_line_amount'] as int? ?? 0,
      ...
      clType: json['cl_type'] as int? ?? 0,
      isForward: json['is_forward'] as int? ?? 0,
      ...
      isFieRespond: json['is_fie_respond'] as int? ?? 0,
      type: json['type'] as String? ?? '',
      parentClId: json['parent_cl_id'] as int? ?? 0,
